# -*- coding: utf-8 -*-
#
# FLOW3 documentation build configuration file, created by
...
project = u'FLOW3'
copyright = u'2011-2012, FLOW3 Core Team'
...
latex_documents = [
  ('Index', 'FLOW3.tex', u'FLOW3 Documentation',
...
man_pages = [
    ('Index', 'flow3', u'FLOW3 Documentation',
     [u'Robert Lemke'], 1)
]
